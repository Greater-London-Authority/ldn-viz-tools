...
-->
<div class="product body-sm relative text-color-text">
	<div
		role="tooltip"
		bind:this={container}
		onwheel={preventZoom}
	...
	{#if !noTip}
		<svg
			...
			viewBox="0 0 150 100"
			class="absolute bottom-0 left-1/2 h-4 w-8 -translate-x-1/2 transform fill-color-container stroke-color-border-muted"
		>
