...
<details>
	<summary class="cursor-pointer dark:text-color-inverse-text">Show data processing</summary>
	```javascript
    let width = $state(0);
...
<details>
    <summary class="cursor-pointer dark:text-color-inverse-text">Show spec</summary>
    ```javascript
    let spec = $derived({
		marginLeft: 0,
		marginRight: 0,
...
<details class="max-h-[300px] overflow-y-auto dark:text-color-inverse-text">
