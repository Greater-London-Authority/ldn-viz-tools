...
import { multiVariableData, singleVariableData, dualVariableData } from '../../../data/demoData';
...
<details>
	<summary class="cursor-pointer">Show spec</summary>
	```javascript
	let spec = $derived({
...
<details class="max-h-[300px] overflow-y-auto">
	<summary class="cursor-pointer">Show data</summary>
	<pre>{JSON.stringify(singleVariableData, null, 2)}</pre>
</details>
...
<details class="max-h-[300px] overflow-y-auto">
	<summary class="cursor-pointer">Show data</summary>
	<pre>{JSON.stringify(multiVariableData, null, 2)}</pre>
</details>
...
<details class="max-h-[300px] overflow-y-auto">
	<summary class="cursor-pointer">Show data</summary>
	<pre>{JSON.stringify(dualVariableData, null, 2)}</pre>
</details>
