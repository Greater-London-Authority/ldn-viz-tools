...
<Template let:args>
	<ScatterPlot
		...
		y="value"
		xDomain={[1979, 2017]}
		xAxis={{ baseline: true, gridlines: true }}
		yAxis={{ baseline: true }}
		markOptions={{ r: 4 }}
	/>
</Template>
...
<Story
	name="With Chrome and lines"
	args={{ title: 'Chart Title', subTitle: 'This is a sub title', footer: true, exportBtns: true, showLine: true }}
/>