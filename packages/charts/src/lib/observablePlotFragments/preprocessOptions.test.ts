...
describe('preprocessOptions', () => {
  ...
  describe('options handling', () => {
    it('should pass static options unchanged', () => {
      ...
      expect(mockMarkFunction).toHaveBeenCalledWith(
        [{ id: 1 }],
        {
          fill: 'red',
          stroke: 'blue',
    ...
    it('should evaluate function provided for dy when in options', () => {
      const data = [{ id: 1, offset: 10 }, { id: 2, offset: 20 }];
      const mockMarkFunction = vi.fn((data, options) => ({ data, options }));
    ...
    it('should evaluate function provided for textAnchor when in options', () => {
      ...
      expect(mockMarkFunction).toHaveBeenNthCalledWith(1, [{ id: 1, align: 'start' }], { textAnchor: 'start' });
      expect(mockMarkFunction).toHaveBeenNthCalledWith(2, [{ id: 2, align: 'end' }], { textAnchor: 'end' });
    });
  ...
  describe('optionsToEval handling', () => {
    it('should evaluate optionsToEval functions', () => {
      ...
      expect(mockMarkFunction).toHaveBeenNthCalledWith(1, [{ id: 1, quarter: '2019 Q4' }], { fill: 'black' });
      expect(mockMarkFunction).toHaveBeenNthCalledWith(2, [{ id: 2, quarter: '2020 Q1' }], { fill: 'GDPType' });
    });
    ...
    it('should combine options and optionsToEval', () => {
      ...
      expect(mockMarkFunction).toHaveBeenCalledWith(
        [{ id: 1, offset: 10, quarter: '2019 Q4' }],
        {
          dy: 10,
          stroke: 'blue',
          fill: 'black',
