...
<Story name="Typography">
	<div class="container">
		<div class="flow-prose prose">
			<h1 class="display mt-spacing-3xl">State of London</h1>
			<!-- <h1 class="prose headline">Skills</h1> -->
			<p class="prose subhead">Skills levels and workforce readiness in London</p>
			...
			<p>
				...
				really want. You don't want to have to remove annoying margins every time you use a <code
					>p</code
				>
			...
			<p>
				...
				undo the top margin on the second heading because it usually looks better for the headings
			...
			<ul>
				<li>
					...
					<p>
						...
						to all make sense. Pretty tough honestly, you could make a strong argument that you just
		...
		plugins: [],
			...
			<p>
				...
				>. We almost made them blue but that's so yesterday, so we went with dark gray, feels
				edgier.
			</p>
			...
			<p>
				Another thing I've done in the past is put a <code>code</code> tag inside of a link, like if
				I wanted to tell you about the
				<a href="https://github.com/tailwindcss/docs"><code>tailwindcss/docs</code></a> repository. I
				don't love that there is an underline below the backticks but it is absolutely not worth the madness
