...
<div
	class="border-color-border-muted bg-color-surface-neutral text-color-text-muted flex h-full w-full flex-col items-center justify-center gap-2 border px-2 py-2 text-center"
>
	{#if spinner}
