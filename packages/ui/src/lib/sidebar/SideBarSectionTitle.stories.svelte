...
<Meta title="Ui/Sidebars/SidebarSectionTitle" component={SidebarSectionTitle} />

<Template let:args>
	<SidebarSectionTitle {...args} />
</Template>

<Story name="Title only">
	<SidebarSectionTitle>Sidebar section title</SidebarSectionTitle>
</Story>
