<script>
	...
	const classesGLaBorder = 'border-2 border-solid border-black dark:border-white';
	const classesGLAPanel = 'relative m-4 space-y-2 w-[800px] h-[300px]';
	const classesGLADescription = 'text-core-grey-500 dark:text-core-grey-200 ml-2';
	const classesGLAButton = classNames('ml-2 p-2 text-lg', classesGLaBorder);
</script>
...
<Story name="Notice">
	<div class={classesGLAPanel}>
		<p class={classesGLADescription}>
		...
		<button class={classNames(classesGLAButton, 'bg-core-blue-500')} on:click={() => postMessage('Notice me!')}>
			Post message
		</button>
...
<Story name="Success">
	<div class={classesGLAPanel}>
		<p class={classesGLADescription}>Post a success message.</p>

		<button
			class={classNames(classesGLAButton, 'bg-core-green-400')}
...
<Story name="Warning">
	<div class={classesGLAPanel}>
		<p class={classesGLADescription}>Post a warning message.</p>

		<button
			class={classNames(classesGLAButton, 'bg-core-organge-500')}
...
<Story name="Error">
	<div class={classesGLAPanel}>
		<p class={classesGLADescription}>Post an error message.</p>

		<button
			class={classNames(classesGLAButton, 'bg-core-red-400')}
...
<Story name="Absolute positioning">
	<div class={classNames(classesGLAPanel, classesGLaBorder)}>
		<p class={classesGLADescription}>By default messages are fixed to the bottom right.</p>
		...
		<button
			class={classNames(classesGLAButton, 'bg-core-blue-500')}
...
<Story name="Timeout: long lived">
	<div class={classesGLAPanel}>
		<p class={classesGLADescription}>By default messages disappear after three and a half seconds.</p>
