...
- conditionally render the [LoginForm](./?path=/docs/ui-auth-login-form--documentation) rather than restricted content based on the value of the `$hasAccess` store
...
<HandleRedirectFromAuth config={oauth_config} {goto} />
