...
<header
	class={`border-color-static-brand border-b-color-border-muted bg-color-container text-color-text flex h-[50px] items-center border-b  border-l-[5px] px-4 py-[.5rem] text-left ${theme}`}
>
