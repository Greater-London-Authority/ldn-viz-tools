<script lang="ts">
	...
	const nonHighlightedClasses =
		'flex h-[50px] bg-color-action-background-secondary hover:bg-color-action-background-secondary-hover text-color-action-text-primary  items-center px-4 py-2 items-center';
	$: {
		if (!page) {
