...
<div class="grid grid-cols-2 xl:grid-cols-4 grid-rows-[auto] gap-4">
    <div class="flow-product">
        ...
        <h3 class="title-4 !mt-2">Foundations</h3>
    ...
    <div class="flow-product">
        ...
        <h3 class="title-4 !mt-2">Quick colour guide</h3>
    ...
    <div class="flow-product">
        ...
        <h3 class="title-4 !mt-2">Colour foundations</h3>
    ...
    <div class="flow-product">
        ...
        <h3 class="title-4 !mt-2">Quantitative colour</h3>
        ...
        <h3 class="title-4 !mt-2">Charts</h3>
        ...
        <h3 class="title-4 !mt-2">Chart examples</h3>
